							...
							<div class="col-lg-12">
								<form id="login-form" action="" method="POST" role="form" style="display: block;">
									<div class="form-group">
										<input type="text" name="txtuser" tabindex="1" class="form-control" placeholder="Tên đăng nhập" value="">
									</div>
									<div class="form-group">
										<input type="text" name="txtpass" tabindex="2" class="form-control" placeholder="Mật khẩu">
									</div>
